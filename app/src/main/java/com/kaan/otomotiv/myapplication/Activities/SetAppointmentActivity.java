            ...
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                ...
                if (!carPlate.isEmpty() && !carKilometer.isEmpty() && !type.isEmpty())
                {
                    if (isOnline())
                    {
                        ...
                        {
                            Toast.makeText(getApplicationContext(),"Lütfen geçerli randevu zamanı seçiniz !", Toast.LENGTH_LONG).show();
                        }
                    }
                    else
                        {
        ...
        try
        {
            ...
            db.collection("APPOINTMENT").add(appointmentData).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                ...
                public void onSuccess(DocumentReference documentReference) {
                    Toast.makeText(getApplicationContext(),"Randevu Oluşturuldu!"+ documentReference.getId(), Toast.LENGTH_SHORT).show();
